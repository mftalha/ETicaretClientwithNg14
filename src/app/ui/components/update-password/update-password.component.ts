...
export class UpdatePasswordComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // url'deki parametreleri yakalıyoruz => refresh token kontrolü için => sayfa yüklenirken : refresh token varmı ve doğrumu
    ...
    this.activatedRoute.params.subscribe({
      next: async params => {
        ...
        () => {
          ...
          //kullanıcı pass değişimi başarılı ise logine yönlendir şifreyi.
